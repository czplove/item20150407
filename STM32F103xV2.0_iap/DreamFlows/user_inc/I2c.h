...
*/
#define I2C1_SDA_IN()  {GPIOB->CRL&=0x00FFFFFFF;GPIOB->CRL|=(UINT32)8<<28;}	//-这里仅仅配置输入输出类型,上拉下拉还需要ODR配置
#define I2C1_SDA_OUT() {GPIOB->CRL&=0x00FFFFFFF;GPIOB->CRL|=3<<28;}

#define I2C2_SDA_IN()  {GPIOB->CRH&=0x0FFFF0FFF;GPIOB->CRH|=8<<12;}	//-这里仅仅配置输入输出类型,上拉下拉还需要ODR配置
#define I2C2_SDA_OUT() {GPIOB->CRH&=0x0FFFF0FFF;GPIOB->CRH|=3<<12;}
...
#define I2C1_SCL_read      (GPIOB->IDR  & GPIO_Pin_6)
#define I2C1_SDA_read      (GPIOB->IDR  & GPIO_Pin_7)

#define I2C2_SCL_H         GPIOB->BSRR = GPIO_Pin_10
#define I2C2_SCL_L         GPIOB->BRR  = GPIO_Pin_10
#define I2C2_SDA_H         GPIOB->BSRR = GPIO_Pin_11
#define I2C2_SDA_L         GPIOB->BRR  = GPIO_Pin_11
#define I2C2_SCL_read      (GPIOB->IDR  & GPIO_Pin_10)
#define I2C2_SDA_read      (GPIOB->IDR  & GPIO_Pin_11)
/*
